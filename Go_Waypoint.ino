...
//Serial1.print(ac);
 ...
 while (true)  
  ...
  //Distance_To_Home = TinyGPSPlus::distanceBetween(gps.location.lat(),gps.location.lng(),Home_LATarray[ac], Home_LONarray[ac]);  //*******************BURADA HESAPLAMA MANUEL OLACAK HAVERSINE İLE. SEKMELER ARASINDA VAR.
  //GPS_Course = TinyGPSPlus::courseTo(gps.location.lat(),gps.location.lng(),Home_LATarray[ac],Home_LONarray[ac]);                //NEMEADISTANCE ÖRNEĞİNE BAK   
